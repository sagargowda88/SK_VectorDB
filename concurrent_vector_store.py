...
class VectorStore:
    def __init__(self, embedding_model='paraphrase-MiniLM-L6-v2', max_workers=4):
    ...
    def find_similar_vectors_batch(self, query_texts, num_results=5):
        with ThreadPoolExecutor(max_workers=self.max_workers) as executor:
            similarity_results = list(executor.map(self.find_similar_vectors, query_texts, [num_results] * len(query_texts)))
